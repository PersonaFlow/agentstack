...
class CRAGMessage(AIMessage):
    ...
    @classmethod
    def from_gradation_step(cls, documents: List[Any], scores: List[float]) -> "CRAGMessage":
    ...
    @classmethod
    def from_query_transformation(cls, original: str, transformed: str) -> "CRAGMessage":
