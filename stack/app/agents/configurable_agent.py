...
class ConfigurableAgent(RunnableBinding[Messages, Sequence[AnyMessage]]):
    ...
    def invoke(
        self, input: Messages, config: Optional[RunnableConfig] = None, **kwargs: Any
    ) -> Sequence[AnyMessage]:
        """Invoke the agent."""
    ...
    def stream(
        ...
        **kwargs: Any,
    ) -> Iterator[Sequence[AnyMessage]]:
        """Stream the agent's output."""
        return self.bound.stream(input, config=config, **kwargs)
    ...
    async def astream(
        ...
        config: Optional[RunnableConfig] = None,
        **kwargs: Any,
    ) -> AsyncIterator[Sequence[AnyMessage]]:
        """Asynchronously stream the agent's output."""
