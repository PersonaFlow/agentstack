...
def check_content_is_useful(document_content: str, min_word_count: int = 10, max_number_ratio: float = 0.3,
                            information_density_ratio: float = 0.5, max_density_word_count: int = 200) -> Tuple[
    bool, str]:
    ...
    if word_count < max_density_word_count and density_ratio < information_density_ratio:
        return False, f"density_ratio={density_ratio} < threshold={information_density_ratio}"
