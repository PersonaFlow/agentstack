...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            0.5,
            0.5,
            (False, "word_count=3 < threshold=10")
        ),
        (
        ...
        (
            "GPT 4Llama270B BaseLlama270B FTLlama213B BaseMistral 7BLlama2 7BBaseMistral 7BFTLlama213B FTLlama2 7BFT GPT 4Llama270B BaseLlama270B FTLlama213B BaseMistral 7BLlama2 7BBaseMistral 7BFTLlama213B FTLlama2 7BFT",
            10,
            0.3,
            0.5,
            (False, "number_ratio=0.5 > threshold=0.3")
        ...
        (
            "18 Llama-3 70B 0102030405060708090100 Llama-3 70B Llama-3 70B Llama-3 70B Llama-3 70B Base Llama-2 7B 46.75 Mistral 7B 59.50 Llama-2 13B 56.00 Llama-2 70B 63.75",
            10,
            0.3,
            0.5,
            (False, "number_ratio=0.5 > threshold=0.3")
...
def test_check_content_is_useful(content: str, min_word_count: int, max_number_ratio: float, information_density_ratio: float, expected: Tuple[bool, str]) -> None:
    assert check_content_is_useful(
