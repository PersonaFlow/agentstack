...
async def test__stream_run__new_thread_creation(mocked_astream_state, mocked_to_sse, valid_payload, random_schema_thread, random_schema_assistant, mock_agent):
