  ...
  return (
    <div
      className={cn(
        ...
        'prose-pre:border prose-pre:border-secondary-100 prose-pre:bg-secondary-50 prose-pre:text-black',
        className,
      )}
    >
      <ReactMarkdown remarkPlugins={[remarkGfm, remarkMath]}>{text}</ReactMarkdown>
    </div>
  )
}
