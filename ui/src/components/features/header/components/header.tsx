...
export default function Header() {
  ...
  const createAssistantStyle = "m-auto flex h-9 text-sm cursor-pointer items-center gap-2 rounded-md border border-white/50 px-3 py-4 text-md text-white transition-colors duration-200 hover:bg-gray-500/40"
