...
- 👥 **Assistants API:** Modeled after OpenGPTs, this API allows the creation of complex, configurable agents that can interact with various data sources and APIs.
- 💾 **Advanced RAG System:** A fully configurable data ingestion system that allows direct queries or agent-mediated interactions.
