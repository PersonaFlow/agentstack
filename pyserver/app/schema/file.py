...
from app.schema.rag import ContextType
...
class FileSchema(BaseModel):
    ...
    purpose: ContextType = Field(..., description="The context for file: eg. 'assistants', 'rag', 'threads', or 'personas'.")
    ...
    source: str = Field(..., description="The source of the file. For local files, this will be the local file path plus filename and extension.")
...
class UploadFileSchema(BaseModel):
    purpose: Optional[ContextType] = Field(default=ContextType.assistants, description="The context for file: eg. 'assistants', 'rag', 'threads', or 'personas'.")
