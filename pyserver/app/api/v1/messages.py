...
from app.repositories.message import MessageRepository, get_message_repository
...
async def update_message(
    ...
    message = await message_repo.update_message(message_id=message_id, data=data.model_dump())
    if message:
        return message
