...
class Message(Base):
    ...
    thread_id: Mapped[str] = mapped_column(
        String(), comment="The ID of the thread to which this message belongs."
    )
    user_id: Mapped[str] = mapped_column(
        String(), comment="The ID of the user who sent the message."
    )
    assistant_id: Mapped[str] = mapped_column(
        String(), comment="The ID of the assistant that processed the message."
    )
