...
down_revision = '42cb7889f092'  # The ID of the previous revision. Specifies ordering of migrations.
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False, comment="A unique identifier for the checkpoint. It's a UUID type and is automatically generated by the database."),
    sa.Column('user_id', sa.String(), nullable=False, comment='The ID of the user to whom the checkpoint belongs.'),
    sa.Column('thread_id', sa.String(), nullable=False, comment='The ID of the thread to which the checkpoint belongs.'),
    sa.Column('checkpoint', sa.LargeBinary(), nullable=False, comment='The serialized checkpoint data.'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='The timestamp when the checkpoint was created.'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='The timestamp when the checkpoint was last updated.'),
