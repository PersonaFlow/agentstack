...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_personaflow_assistants_user_id"),
        "assistants",
        ["user_id"],
        unique=False,
        schema="personaflow",
    ...
    op.create_index(
        op.f("ix_personaflow_files_created_at"),
        "files",
        ["created_at"],
        unique=False,
        schema="personaflow",
    ...
    op.create_index(
        op.f("ix_personaflow_files_user_id"),
        "files",
        ["user_id"],
        unique=False,
        schema="personaflow",
    ...
    op.alter_column("messages", "type", new_column_name="role", schema="personaflow")
    op.alter_column(
        "messages",
        "additional_kwargs",
    ...
    op.create_index(
        op.f("ix_personaflow_checkpoints_thread_id"),
        "checkpoints",
        ["thread_id"],
        unique=False,
        schema="personaflow",
...
def downgrade() -> None:
    ...
    op.drop_column("assistants", "kwargs", schema="personaflow")
    op.drop_column("assistants", "file_ids", schema="personaflow")
    ...
    op.alter_column("messages", "role", new_column_name="type", schema="personaflow")
    op.alter_column(
        "threads",
        "kwargs",
        new_column_name="additional_kwargs",
    ...
    op.drop_table("files", schema="personaflow")
