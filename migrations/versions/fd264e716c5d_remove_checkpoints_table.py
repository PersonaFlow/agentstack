...
from sqlalchemy.dialects import postgresql  # Import additional modules dynamically based on the migration's needs.
...
down_revision = 'af0a5f3e2816'  # The ID of the previous revision. Specifies ordering of migrations.
