...
down_revision = '1091347b4ab9'  # The ID of the previous revision. Specifies ordering of migrations.
...
def upgrade() -> None:
    ...
    sa.Column('token_id', sa.String(), nullable=False, comment='The ID of the token to be blacklisted.'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='The timestamp when the token was blacklisted.'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='The timestamp when the token was last updated.'),
    sa.PrimaryKeyConstraint('id'),
    schema='personaflow'
    )
    op.create_index(op.f('ix_personaflow_blacklist_token_id'), 'blacklist', ['token_id'], unique=False, schema='personaflow')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_personaflow_blacklist_token_id'), table_name='blacklist', schema='personaflow')
